 ...
 <?php } ?>
  ...
  <div id="admin_dialog" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
        ...
        <div class = "container-fluid">
            ...
            <div  class = "option" class = "display:block">
            <img src="add_cata.png" alt="add_item" style = "background-color:white;"></img>
            Add Catagory
          </div>
          </a>
              </div>
...
<div id = "search" class = "span2 thumbnail" style = "text-align:center">
  <h3>Search</h3>
  <hr></hr>
    <form id = "searchText" action = "search/search_data.php">
      <div class = "control-group">
	...
	<h3 class = "animated fadeIn"> Search Result : '<?php echo $_REQUEST["res"];?>' <small class="pull-right"> <?php echo count($_SESSION["res"]); ?> products are available </small></h3>
	<hr class="soft"/>
...
<div class="tab-content">
    ...
    <?php for($i = 0 ; $i<count($_SESSION["res"]) ;$i++) { ?>
    <form id = "listForm<?php echo $i; ?>"action = "product_details.php" method = "GET">
      <div class="row">
        <div class = "span1"></div>
        <div class="span2">
          <img src="<?php echo $_SESSION["res"][$i]["directory"]; ?>" alt=""/>
        </div>
        <div class="span5">
          <h3><?php echo $_SESSION["res"][$i]["item_name"]; ?></h3>
          <hr class="soft"/>
          <h5>Description </h5>
          <p style = "word-wrap: break-word;">
          <?php echo $_SESSION["res"][$i]["Detail"]; ?>
          </p>
          ...
          <input type = "hidden" name = "item_directory" value = "<?php echo $_SESSION["res"][$i]["directory"]; ?>"></input>
          <input type = "hidden" name = "item_name" value = "<?php echo $_SESSION["res"][$i]["item_name"]; ?>"></input>
          <input type = "hidden" name = "item_detail" value = "<?php echo $_SESSION["res"][$i]["Detail"]; ?>"></input>
          <input type = "hidden" name = "item_price" value = "<?php echo $_SESSION["res"][$i]["Price"]; ?>"></input>
          <input type = "hidden" name = "item_stock" value = "<?php echo $_SESSION["res"][$i]["amount"]; ?>"></input>
          <input type = "hidden" name = "item_catagory" value = "<?php echo $_SESSION["res"][$i]["catagoryID"]; ?>"></input>View Details</a>
          <br class="clr"/>
        </div>
        <div class="span3 alignR">
        <form class="form-horizontal qtyFrm">
          <h3> THB <?php echo $_SESSION["res"][$i]["Price"]; ?></h3>
        </form>
        <form id = "listFormCart<?php echo $i ?>" action = "cart/cart.php" method="GET">
          ...
          <input type = "hidden" name = "item_price" value = "<?php echo $_SESSION["res"][$i]["Price"]; ?>"></input>
          <input type = "hidden" name = "item_stock" value = "<?php echo $_SESSION["res"][$i]["amount"]; ?>"></input>
          <input type = "hidden" name = "item_catagory" value = "<?php echo $_SESSION["res"][$i]["catagoryID"]; ?>"></input>

              <div id = "gallery">
                <a href="<?php echo $_SESSION["res"][$i]["directory"]; ?>" class="button-black" title = "<?php echo $_SESSION["res"][$i]["item_name"]; ?>" ><i class="icon-zoom-in"></i></a>
                <a href = "#" onclick = "$('#listFormCart<?php echo $i ?>').submit()"class="button-black"> Add to <i class=" icon-shopping-cart"></i></a>
  ...
  <div class="tab-pane active " id="blockView" >
        ...
        <?php for($i = 0 ; $i< count($_SESSION["res"]) ; $i++) {  //count($_SESSION["list"])?>
          ...
          <form id = "form_detail<?php echo $i; ?>" action = "product_details.php" method = "GET">
                <center><a href="#" onclick ="$('#form_detail<?php echo $i; ?>').submit()" ><img src="<?php echo $_SESSION["res"][$i]["directory"]; ?>" alt="" style = "width:200px;height:200px"/></a></center>
                <input type = "hidden" name = "index" value = "<?php echo $i; ?>"></input>
                <input type = "hidden" name = "item_ssn" value = "<?php echo $_SESSION["list"][$i]["ComputerPartSSN"]; ?>"></input>
                <input type = "hidden" name = "item_directory" value = "<?php echo $_SESSION["res"][$i]["directory"]; ?>"></input>
                <input type = "hidden" name = "item_name" value = "<?php echo $_SESSION["res"][$i]["item_name"]; ?>"></input>
            ...
            <div class = "row-fluid">
              <div class = "span11">
                    <form id = "blockForm<?php echo $i ?>" action = "cart/cart.php" method="GET">
                      ...
                      <h5 style = "white-space: nowrap;overflow:hidden;max-width:200px"><strong><?php echo  $_SESSION["res"][$i]["item_name"]; ?></strong></h5>
                      ...
                      <input type = "hidden" name = "item_price" value = "<?php echo $_SESSION["res"][$i]["Price"]; ?>"></input>
                      <div>
                              <h5>THB <?php echo $_SESSION["res"][$i]["Price"]; ?></h5>
                              <hr class = "soft">
                              <div class = "container-fluid">
                                    <div class = "row-fluid">
                                        <div style = "width:120%">
                                          <div id = "gallery">
                                              <a href="<?php echo $_SESSION["res"][$i]["directory"]; ?>" class="button-black hvr-glow" title = "<?php echo $_SESSION["res"][$i]["item_name"]; ?>" style = "text-decoration:none"><i class="icon-zoom-in"></i></a>
                                              <span>
